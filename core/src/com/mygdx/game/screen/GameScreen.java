...
import com.mygdx.game.SantaECSGame;
...
import com.mygdx.game.ecs.system.PresentSpawnSystem;
import com.mygdx.game.ecs.system.RenderSystem;
import com.mygdx.game.ecs.system.SantaInputSystem;
import com.mygdx.game.ecs.system.SnowmanSpawnSystem;
...
//    private final AstronautGame game;
    ...
    public GameScreen(SantaECSGame game) {
//        this.game = game;
    ...
    public void show() {
        ...
        engine.addSystem(new SantaInputSystem());
        engine.addSystem(new MovementSystem());
        engine.addSystem(new WorldWrapSystem());
        engine.addSystem(new BoundsSystem());
        engine.addSystem(new SnowmanSpawnSystem());
        engine.addSystem(new PresentSpawnSystem());
